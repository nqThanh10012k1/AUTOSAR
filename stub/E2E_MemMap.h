...
#undef MEMMAP_ERROR
#elif defined( E2E_START_SEC_CONST)
#undef E2E_START_SEC_CONST
#undef MEMMAP_ERROR
#elif defined( E2E_START_SEC_VAR)
#undef E2E_START_SEC_VAR
#undef MEMMAP_ERROR
#endif
...
#undef MEMMAP_ERROR
#elif defined( E2E_STOP_SEC_CONST)
#undef E2E_STOP_SEC_CONST
#undef MEMMAP_ERROR
#elif defined( E2E_STOP_SEC_VAR)
#undef E2E_STOP_SEC_VAR
#undef MEMMAP_ERROR
