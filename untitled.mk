...
## Generated on : Tue Feb 04 01:26:42 2025
...
START_DIR                 = C:/Users/PC/Documents/SIMULINK/AUTOSAR/E2E
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/untitled_autosar_rtw -I$(MATLAB_ROOT)/toolbox/coder/autosar/rte -I$(START_DIR)/untitled_autosar_rtw/stub -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
SRCS = $(START_DIR)/untitled_autosar_rtw/untitled.c
...
%.obj : $(START_DIR)/untitled_autosar_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")


%.obj : $(START_DIR)/untitled_autosar_rtw/stub/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
...
untitled.obj : $(START_DIR)/untitled_autosar_rtw/untitled.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
